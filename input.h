...
#define BUTTON_Y		0x00000100l	// Ｙボタン(.rgbButtons[4]&0x80)L1
#define BUTTON_Z		0x00000200l	// Ｚボタン(.rgbButtons[5]&0x80)R1
#define BUTTON_L		0x00000400l	// Ｌボタン(.rgbButtons[6]&0x80)L2
#define BUTTON_R		0x00000800l	// Ｒボタン(.rgbButtons[7]&0x80)L2
